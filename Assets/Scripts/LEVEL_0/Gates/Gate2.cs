...
public class Gate2 : MonoBehaviour
{
    ...
    [SerializeField] GameObject ESK8;
    [SerializeField] GameObject ESK9;
    [SerializeField] GameObject ESK10;
    [SerializeField] GameObject ESK11;

    private void Update()
    {
        if (CheckHealth(ESK1) && CheckHealth(ESK2) && CheckHealth(ESK3) &&
            CheckHealth(ESK4) && CheckHealth(ESK5) && CheckHealth(ESK6) &&
            CheckHealth(ESK7) && CheckHealth(ESK8) && CheckHealth(ESK9) &&
            CheckHealth(ESK10) && CheckHealth(ESK11))
        {
            Destroy(gameObject);
        }
