...
public class Boss_2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        L1 = Laser1.GetComponent<Hovl_DemoLasers>();
        L2 = Laser2.GetComponent<Hovl_DemoLasers>();
    }
    ...
    void Update()
    {
        ...
        if (canMove)
        {
            ...
            boss_2.isStopped = false;
            boss_2.SetDestination(target.position);
            isChasePlayer = true;
